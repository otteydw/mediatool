...
def test_consolidate_files_db(datafiles: Path):
    ...
    engine = create_engine(f"sqlite+pysqlite:///{DBFILE}", echo=True)
    ...
    with Session(engine) as session:
        ...
        # print(f"Found {len(duplicates)} total files.")
